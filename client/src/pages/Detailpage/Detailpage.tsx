            ...
            <div className="detailpage_left col-md-9 ">
              <div className="content_detailpage_card ">
                <div className="d-flex flex-column flex-md-row content_detail_card_child">
                  <div className="col-12 col-sm-4 image_card_detailpage" style={{ display: 'inline-block', position: 'relative' }}>
                    <img className='img-fluid' style={{ width: '100%', maxWidth: 290, height: 400 }} src={datadetail?.hinhanh ? datadetail.hinhanh : ''} alt="" />
                  ...
                  <div className='col-sm-8 col-12 card_detailpage_film' style={{ marginLeft: 15 }}>
                    <div className="">
                        ...
                        checkbutton === 1 ? (<div className="">
                          ...
                          <div className="list_episode">
                            {datadetail?.linkfilms.map((episodelist: { episode: number }, key: number) => (
                              <button key={key}><Link to={`/xem-phim/${datadetail?.title}/tap-${episodelist.episode}`} state={{ data_phimhot: memophimhot || [] }} >Tập {episodelist.episode}</Link></button>
                            ))}
