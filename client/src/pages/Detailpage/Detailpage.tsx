...
export default function Detailpage() {
 const {
  ...
  const settings = useMemo(() => ({
    ...
    responsive: [
      { breakpoint: 1400, settings: { slidesToShow: 4, slidesToScroll: 3, infinite: true }},
      { breakpoint: 1200, settings: { slidesToShow: 3, slidesToScroll: 2, infinite: true }},
      ...
      { breakpoint: 840, settings: { slidesToShow: 4, slidesToScroll: 3, infinite: true }},
